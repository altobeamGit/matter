...
pw_set_backend(pw_sys_io pw_sys_io.atbm)
pw_set_backend(pw_trace pw_trace_tokenized)

add_subdirectory(${chip_dir}/third_party/pigweed/repo ${chip_dir}/examples/lighting-app/atbm/out/pigweed)
add_subdirectory(${chip_dir}/third_party/nanopb/repo ${chip_dir}/examples/lighting-app/atbm/out/nanopb)
add_subdirectory(${chip_dir}/examples/platform/atbm/pw_sys_io ${chip_dir}/examples/lighting-app/atbm/out/pw_sys_io)
...
MESSAGE( STATUS "prj_root=${prj_root}")

include(${prj_root}/asdk/includepath.cmake)

if (matter_enable_rpc)
list(
    APPEND ${list_chip_main_sources}
    #rpc
    ${chip_dir}/examples/platform/atbm/PigweedLogger.cpp
    ${chip_dir}/examples/platform/atbm/Rpc.cpp
    ${chip_dir}/examples/common/pigweed/RpcService.cpp
    ${chip_dir}/examples/common/pigweed/atbm/PigweedLoggerMutex.cpp
)
endif (matter_enable_rpc)
...
list(
    ...
    ${chip_dir}/examples/platform/atbm/ota/OTAInitializer.cpp
)
...
list(
    ...
    ${chip_dir}/examples/lighting-app/atbm/main/chipinterface.cpp
    ${chip_dir}/examples/lighting-app/atbm/main/DeviceCallbacks.cpp
    ${chip_dir}/examples/lighting-app/atbm/main/CHIPDeviceManager.cpp
    ${chip_dir}/examples/lighting-app/atbm/main/Globals.cpp
    ${chip_dir}/examples/lighting-app/atbm/main/LEDWidget.cpp
    ${chip_dir}/examples/lighting-app/atbm/main/DsoHack.cpp
...
target_include_directories(
    ...
    PUBLIC
    #rpc
    ${chip_dir}/examples/platform/atbm
    ${chip_dir}/examples/platform/atbm/pw_sys_io/public
    ${chip_dir}/examples/common
    ${chip_dir}/examples/common/pigweed
    ${chip_dir}/examples/common/pigweed/atbm
    ${chip_dir}/src
...
target_include_directories(
    ...
    ${chip_dir}/examples/lighting-app/atbm/main/include
    ${chip_dir}/examples/platform/atbm
...
list(
    ...
    -DCHIP_PROJECT=1
    -DCHIP_DEVICE_LAYER_TARGET=Atbm
    -DUSE_ZAP_CONFIG
    -DCHIP_HAVE_CONFIG_H
