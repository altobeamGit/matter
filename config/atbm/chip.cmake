...
message( STATUS "chip_dir:${chip_dir}")
...
string(APPEND CHIP_GN_ARGS "pw_sys_io_BACKEND = \"//third_party/connectedhomeip/examples/platform/atbm/pw_sys_io:pw_sys_io_atbm\"\n")
...
ExternalProject_Add(
    ...
    CONFIGURE_COMMAND       gn --root=${CHIP_ROOT}/config/atbm gen --check --fail-on-unused-args ${CHIP_OUTPUT}
    BUILD_COMMAND           ninja -C ${CHIP_OUTPUT} :atbm
    INSTALL_COMMAND         ""
