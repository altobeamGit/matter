...
#include <platform/Atbm/AmebaConfig.h>
#include <platform/Atbm/AmebaUtils.h>
#include <platform/Atbm/ConfigurationManagerImpl.h>
...
CHIP_ERROR AmebaUtils::SetWiFiConfig(void * config)
...
CHIP_ERROR AmebaUtils::GetWiFiConfig(void * config)
